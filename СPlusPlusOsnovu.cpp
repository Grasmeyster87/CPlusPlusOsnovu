        ...
        case(136):
        {
          ...
          +30)  swap 	        Меняет местами элементы двух векторов.
            ...
            */
            ...
            //vector<int>::const_iterator myVector1_it_cend = myVector1.cend();
            ...
            //get_allocator 	Возвращает объект классу allocator, используемому вектором." << endl;
            ...
            //swap 	Меняет местами элементы двух векторов." << endl;
