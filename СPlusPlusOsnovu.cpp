...
-            Возвращает итератор на первый вставленный элемент.
        ...
        case(144):
        {
            ...
            */
            ...
            cout << " ============================================ max_size() ======================================================" << endl << endl;
            /*
            В C++ контейнер `std::set` имеет функцию-член **`max_size()`**, которая возвращает максимально возможное количество элементов, которое данный контейнер может хранить.
            */
            set<int> s_max_size;
